...
@media only screen and (min-device-width: 414px) {
    ...
    <style>
	    ...
	    .primary{
	background: {{config('notify.channels.mail.primary_clr')}};
}
.bg_white{
	background: #ffffff;
}
...
/* 17bebb */
a{
	color: {{config('notify.channels.mail.primary_clr')}};
}
          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: left;">
                        @if(config('notify.channels.mail.logo'))
                        <img src="{{config('notify.channels.mail.logo')}}" width="150" alt="">
                        @else
                        <h1><a href="#">{{config('notify.channels.mail.title')}}</a></h1>
                        @endif
			          </td>
          		</tr>
          	</table>
